...
const mainRoutes = [
  ...
  { 
    path: "pipeline", 
    element: <Suspense fallback={<LoadingSpinner />}><Pipeline /></Suspense> 
  },
  { 
    path: "contacts", 
    element: <Suspense fallback={<LoadingSpinner />}><Contacts /></Suspense> 
  },
  { 
    path: "deals", 
    element: <Suspense fallback={<LoadingSpinner />}><Deals /></Suspense> 
  },
  { 
    path: "*", 
